...
app.register_blueprint(attendance_bp, url_prefix="/api/admin/attendance", name="attendance_admin_alias")
app.register_blueprint(attendance_bp, url_prefix="/api/superadmin/attendance", name="attendance_superadmin_alias")
app.register_blueprint(attendance_bp, url_prefix="/api/management/attendance", name="attendance_mgmt_alias")
...
app.register_blueprint(dept_bp, url_prefix="/api/department_management", name="dept_mgmt_alias")
...
app.register_blueprint(expense_bp, url_prefix="/api/travel-expenses", name="travel_expenses_alias")
